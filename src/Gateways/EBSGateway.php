...
class EBSGateway implements PaymentGatewayInterface {
    ...
    /**
     * EBSGateway constructor.
     */
    function __construct()
    {
        $this->secretKey = Config::get('dekts.ebs.secretKey');
        $this->testMode = Config::get('dekts.testMode');

        $this->parameters['channel'] = 0;       // Standard
        $this->parameters['account_id'] = Config::get('dekts.ebs.account_id');
        ...
        $this->parameters['return_url'] = url(Config::get('dekts.ebs.return_url'));
    }
    ...
    public function send()
    {
        ...
        return View::make('dekts::ebs')->with('hash',$this->hash)

...
class InstaMojoGateway implements PaymentGatewayInterface {
    ...
    /**
     * InstaMojoGateway constructor.
     */
    function __construct()
    {
        $this->testMode = Config::get('dekts.testMode');
        $this->api_key = Config::get('dekts.instamojo.api_key');
        $this->auth_token = Config::get('dekts.instamojo.auth_token');

        $this->parameters['redirect_url'] = url(Config::get('dekts.instamojo.redirectUrl'));
    }
    ...
    public function send()
    {
        ...
        return View::make('dekts::instamojo')->with('longurl',$this->response->payment_request->longurl);
    }

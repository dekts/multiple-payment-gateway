...
class CCAvenueGateway implements PaymentGatewayInterface {
    ...
    /**
     * CCAvenueGateway constructor.
     */
    function __construct()
    {
        $this->workingKey = Config::get('dekts.ccavenue.workingKey');
        $this->accessCode = Config::get('dekts.ccavenue.accessCode');
        $this->testMode = Config::get('dekts.testMode');
        $this->parameters['merchant_id'] = Config::get('dekts.ccavenue.merchantId');
        $this->parameters['currency'] = Config::get('dekts.ccavenue.currency');
        $this->parameters['redirect_url'] = url(Config::get('dekts.ccavenue.redirectUrl'));
        $this->parameters['cancel_url'] = url(Config::get('dekts.ccavenue.cancelUrl'));
        $this->parameters['language'] = Config::get('dekts.ccavenue.language');
    }
    ...
    public function send()
    {
        ...
        return View::make('dekts::ccavenue')->with('encRequest',$this->encRequest)
